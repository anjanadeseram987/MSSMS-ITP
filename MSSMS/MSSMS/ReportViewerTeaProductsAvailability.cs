...
namespace MSSMS
{
    public partial class ReportViewerTeaProductsAvailability : Form
    {
        ...
        public ReportViewerTeaProductsAvailability(ReportType reportType, DateTime startDateTime, DateTime endDateTime)
        {
            InitializeComponent();
        ...
        private void ReportViewerTeaProductsAvailability_Load(object sender, EventArgs e)
        {
        ...
        private void generateMonthlyReport()
        {
            ...
            teaProducts = reportsDBHandler.getMonthlyTeaProductAvailabilityReport(statDateTime);
            dataGridReport.Rows.Clear();

            //binding
            foreach (TeaProduct teaProduct in teaProducts)
            {
                dataGridReport.Rows.Add(teaProduct.teaProductId, teaProduct.teaProductserialNo, teaProduct.teaProductName, teaProduct.teaProductflavor, teaProduct.total_items_count != 0 ? (Math.Round((((Decimal) teaProduct.used_by_items_count) / ((Decimal)teaProduct.total_items_count)) * 100 , 2)).ToString() + "%" : "0%", teaProduct.teaProductavailability, teaProduct.used_by_items_count);
            }
